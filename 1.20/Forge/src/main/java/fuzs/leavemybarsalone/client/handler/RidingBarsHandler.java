...
public class RidingBarsHandler {
    ...
    public static final IGuiOverlay FOOD_LEVEL_MOUNTED = (gui, poseStack, partialTick, screenWidth, screenHeight) -> {
    ...
    public static final IGuiOverlay EXPERIENCE_BAR_MOUNTED = (gui, poseStack, partialTick, screenWidth, screenHeight) -> {
